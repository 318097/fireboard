  ...
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Fireboard, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Fireboard App.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Fireboard App, accessible from{" "}
            <a
              href="https://fireboard.netlify.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://fireboard.netlify.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: mehullakhanpal@gmail.com</li>
      </ul>
    </div>
  );
};
